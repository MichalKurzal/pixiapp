...
var watercolor =  new PIXI.Texture.fromImage("resources/watercolor.jpg");
...
var back = new PIXI.Sprite(watercolor);
...
function Media() {
  if (window.innerWidth > 800 && site == 'main') { // If media query matches
    console.log('> 800');
...
app.ticker.add((delta) => {
   ...
   // gsap.to(icon2, {x : window.innerWidth -300, duration:2})
});
